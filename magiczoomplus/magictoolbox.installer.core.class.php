<?php
    ...
    class MagicToolboxCoreInstallerClass {
        ...
        function sendStat($mode = '') {
            ...
            if('working' == 'v4.9.20' || 'working' == 'v4.5.39') {
                return;
            }
            ...
            $path = "api/stat/?action={$mode}&tool_name=magiczoomplus&license=trial&tool_version=v4.5.39&module_version=v4.9.20&platform_name=magento&platform_version={$platformVersion}&url={$url}";

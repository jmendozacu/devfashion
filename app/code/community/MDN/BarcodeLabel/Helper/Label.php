...
class MDN_BarcodeLabel_Helper_Label extends Mage_Core_Helper_Abstract {
    ...
    /**
     * Nb : 'height' parameter is only used for the logo + product image + barcode image, the same for 'width'
     * 
    ...
    protected function truncateToSize($image, $fontSize, $position, $color, $font, $text) {
        ...
        foreach ($lines as $line){
            ...
            // NB : position['y'] => 'X' by '50px' by 'coef' => 0.1 x 50 x 2 .The same for position['x']

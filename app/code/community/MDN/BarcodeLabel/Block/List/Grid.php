...
class MDN_BarcodeLabel_Block_List_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection = Mage::getModel('BarcodeLabel/List')
                ->getCollection()
                //->joinTable('BarcodeLabel/ProductVarchar', 'value=bll_barcode', array('entity_id' => 'entity_id'), 'attribute_id=' . $barcodeAttributeId.' and store_id = 0', 'left')
                //->joinTable('catalog/product', 'entity_id=entity_id', array('sku' => 'sku'), '', 'left')
                ;

...
class EcommerceTeam_Sln_Block_Adminhtml_Catalog_Product_Attribute_Edit_Tab_Main extends Mage_Adminhtml_Block_Catalog_Product_Attribute_Edit_Tab_Main
{
    ...
    protected function _prepareForm()
    {
        ...
        $typeField = $fieldset->addField('frontend_type', 'select', array(
         ...
         $fieldset->addField('options_limit', 'text', array(
            'name'  => 'options_limit',
            'label' => Mage::helper('catalog')->__('Options limit for show more/less (leave 0 for no limit)'),
            'title' => Mage::helper('catalog')->__('Options limit for show more/less (leave 0 for no limit)'),
        ));

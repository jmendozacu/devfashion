...
class EcommerceTeam_Sln_Block_Layer_View extends Mage_Catalog_Block_Layer_View{
    ...
    public function renderView()
    {
        ...
        if(Mage::helper('ecommerceteam_sln')->getConfigFlag('hidehtml') && 'XMLHttpRequest' != $this->getRequest()->getHeader('X-Requested-With')){
    ...
    {
        return Mage::helper('ecommerceteam_sln/layer')->getFilterableAttributesByGroup($this->_navigationGroup);
    }
